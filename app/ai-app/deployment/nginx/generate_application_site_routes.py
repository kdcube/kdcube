...
def routes_block(route_prefix: str, forwarded_proto: str, indent: str) -> str:
    ...
    lines = [
        ...
        f"location ^~ {route_prefix}/assets/ {{",
        ...
        "}",
        "",
        f"location = {route_prefix}/config.json {{",
