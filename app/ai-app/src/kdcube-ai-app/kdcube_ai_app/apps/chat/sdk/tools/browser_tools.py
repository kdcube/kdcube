...
class BrowserTools:
    ...
    @kernel_function(
        name="open_page",
        description=(
            "Open a URL, file:// URL, canonical OUTPUT_DIR-relative path, or conv:fi:conv_<conversation_id>.turn_<id>.files/... artifact "
    ...
    async def open_page(
        self,
        url_or_path: Annotated[str, "URL, file:// URL, canonical OUTPUT_DIR-relative path, or conv:fi:conv_<conversation_id>.turn_<id>.files/... logical file path."],
