...
| `kdcube reload <bundle_id> [--workdir <path>] [--verbose]` | Reapply `bundles.yaml` from the active runtime and clear proc bundle caches. Normal output is concise; `--verbose` shows the raw Docker Compose command and proc response. |
