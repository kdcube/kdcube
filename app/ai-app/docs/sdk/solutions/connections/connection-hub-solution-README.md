...
| Register your own MCP server, hand chosen tools to Claude Desktop or Claude Code, and let a hosted agent take them through its descriptor ceiling | [Custom MCP Connectors And Governed Invocation](https://github.com/elenaviter/app-ecosystem/blob/main/docs/connection-hub/custom-mcp-connector.md) and [Use A Custom MCP Server From KDCube Agents And External Clients](../../../recipes/connections/custom-mcp-connector-README.md) |
