...
The canonical background job stream documentation is now:

- [../streams/background-jobs-README.md](../streams/background-jobs-README.md)

The broader stream-family map is:

- [../streams/README.md](../streams/README.md)

This compatibility page remains so older links to
`docs/service/jobs/jobs-stream-README.md` do not break.
