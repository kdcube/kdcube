...
| `proxylogin` | optional Fargate service | `8080` | Delegated auth service. `auth.proxy_login.enabled` selects zero or one ECS task; the server-side login lane uses zero. |
